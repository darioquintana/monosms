...
namespace Mono.Sms.Core
{
    public class Agenda
    {
        private const string pathFile = "files/contacts.monosms";
            ...
            try
            {
                ...
                if (!File.Exists(pathFile))
                {
                    ...
                    if (!Directory.Exists("files"))
                    {
                        ...
                        Console.WriteLine("cre̩ el directorio");
                    }
                    ...
                    Console.WriteLine("Cre̩ el archivo de texto {0}", pathFile);
                }
                ...
                sr.Close();
                Console.WriteLine("Cerr̩ el archivo");
